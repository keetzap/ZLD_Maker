...
namespace Keetzap.ZeldaMaker
{
    ...
    [CustomEditor(typeof(RespawnLevelPoint))]
    public class RespawnLevelPointInspector : BaseEditor
    {
        private RespawnLevelPoint respawnPoint;
        ...
        void OnEnable()
        {
            respawnPoint = (RespawnLevelPoint)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EndInspector(respawnPoint, "Respawn Level Point");
        }
