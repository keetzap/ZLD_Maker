...
namespace Keetzap.ZeldaMaker
{
    public class CameraTriggerDolly : CameraTriggerRoomBase
    {
        ...
        protected void AssignTrackedDollyComponent(Vector3 pathOffset, Vector3 waypointA, Vector3 waypointB)
        {
            ...
            spline.Splines[0].RemoveAt(0);
            spline.Splines[0].Add(new BezierKnot(waypointA), TangentMode.AutoSmooth);
            spline.Splines[0].Add(new BezierKnot(waypointB), TangentMode.AutoSmooth);
